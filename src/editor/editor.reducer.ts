...
import { ADD_ARTICLE_REQUESTED, ADD_ARTICLE_FAILED, ADD_ARTICLE_COMPLETED } from './editor.actions';
...
const editor: Reducer<EditorState, RootAction> = (state = initialState, action) => {
    switch (action.type) {
