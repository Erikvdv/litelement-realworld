...
import { navigate } from '../actions/app-root';
...
// Actions Interfaces
export interface ActionLoginRequested extends Action<'LOGIN_REQUESTED'> { userLogin: UserLogin; }
export interface ActionLoginRefreshRequested extends Action<'LOGIN_REFRESH_REQUESTED'> { }
export interface ActionLoginCompleted extends Action<'LOGIN_COMPLETED'> { user: User; }
export interface ActionLoginFailed extends Action<'LOGIN_FAILED'> { errors: Errors; }


export type LoginAction =
    ActionLoginRequested | ActionLoginRefreshRequested |
...
const loginRequested: ActionCreator<ActionLoginRequested> = (userLogin: UserLogin) => {
    return {
...
const loginRefreshRequested: ActionCreator<ActionLoginRefreshRequested> = (user: User) => {
    return {
...
export const loginUser: ActionCreator<ThunkResult> = (userLogin: UserLogin) => async (dispatch) => {
